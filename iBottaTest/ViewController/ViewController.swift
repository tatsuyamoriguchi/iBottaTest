...
//                self.saveJSON2CoreData(offers: self.offers!)
//            }
//        } else {
//            print("OK, offers exists")
//        }
...
//    func saveJSON2CoreData(offers: [ItemOffer]) {
//        let request = NSFetchRequest<NSFetchRequestResult>(entityName: "Like")
//        do {
//
//            let fetch = try context.fetch(request)
//            for data in fetch as! [NSManagedObject] {
//                let likeData = Like(id: data.value(forKey: "id") as! string), like: false))
//                self.dataList.append(likeData)
////            }
//                print("Reading JSON data was successful."
//
//            } catch {
//            print(error)
//
